  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Padding(
            ...
            child: Obx(
              () => applicationController.getDetalApplicationFormLoading.value
                      ...
                      Row(children: [
                        Expanded(
                            child: _buildDetailItem(
                                Icons.person_outline, 'Name', 'Varma')),
                        kWidth10,
                        Expanded(
                            child: _buildDetailItem(
                      ...
                      Row(children: [
                        ...
                        Expanded(
                            child: _buildDetailItem(Icons.access_time,
                                'Parent Number', '989537885)'))
                      ]),
                      kHeight20,
                      Row(children: [
                        Expanded(
                            child: _buildDetailItem(Icons.access_time,
                                'Parent Passport', '6567878574')),
                        kWidth10,
                        Expanded(
                            child: _buildDetailItem(Icons.access_time,
                                'Parent Emirates', '7487853434'))
                      ]),
                      kHeight20,
                      Row(children: [
                        Expanded(
