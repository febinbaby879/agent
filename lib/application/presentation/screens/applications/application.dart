...
class ApplicationTabSection extends StatefulWidget {
  const ApplicationTabSection({super.key});

  @override
  State<ApplicationTabSection> createState() => _ApplicationTabSectionState();
}

class _ApplicationTabSectionState extends State<ApplicationTabSection>
    ...
    return Padding(
        ...
        child: Column(children: [
          ...
          Expanded(child: LayoutBuilder(builder: (context, constraints) {
            ...
            return Obx(() => applicationController
                ...
                : applicationController.allApplicationData.value.applications !=
                    ...
                    ? GridView.builder(
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            ...
                            crossAxisSpacing: 16,
                            mainAxisSpacing: 16),
                        itemCount: applicationController.allApplicationData
                                .value.applications?.length ??
                            0,
                        itemBuilder: (context, index) => ApplicationStudentCard(
                            applicationModel: applicationController
                                .allApplicationData.value.applications?[index],
                            index: index))
                    : const Center(child: Text('No Student Records')));
          }))
        ]));
  }
