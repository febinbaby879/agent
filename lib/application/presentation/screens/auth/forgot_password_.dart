...
import 'package:agent_dashboard/application/presentation/screens/auth/widgets/forgot_password_card.dart';
...
class ScreenForgorPassword extends StatelessWidget {
  const ScreenForgorPassword({super.key});
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Obx(
                          () {
                            if (controller.showOtpForgotPassword.value) {
                              return const OtpCard(register: false);
                            }
