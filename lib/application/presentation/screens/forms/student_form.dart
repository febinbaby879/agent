...
class _StudentApllicationFormState extends State<StudentApllicationForm> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> stepTitles = const [
      'Choose Course, Preffred Country and Visa',
    ...
    bool validateCurrentStep() {
      ...
      switch (activeStep) {
        case 0:
          ...
          if (formController.selectedPreferredCountry.value.isEmpty) {
            showSnackbar('Select Your Preferred Country');
            return false;
          }
          if (formController.selectedVisaOption.value.isEmpty) {
            showSnackbar('Select Your Visa Requiremet');
            return false;
          }
          return true;
        case 1:
        ...
        case 4: // Final Submission
          ...
          if (formController.passportImagesFront.isEmpty) {
            missingDocs.add("Passport Image Front");
          }
          if (formController.passportImagesBack.isEmpty) {
            missingDocs.add("Passport Image Back");
          }
                            ...
                            children: [
                              ...
                              EventButton(
                                  ...
                                  text: activeStep == upperBound
                                      ...
                                      : 'Continue',
                                  onTap: () {
                                    //formController.formSubmi(context);
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        kHeight20,
        const SizedBox(height: 10),
        Text('Visa', style: textHeadStyle1),
        kHeight30,
        Obx(() => CustomDropDownBuilder(
            items: const ['Yes', 'No'],
            hintText: 'Do You Need Visa',
            onChanged: (course) =>
                formController.changeVisa(visa: course ?? ''),
            selectedvalue: formController.selectedVisaOption.value))
      ]),
    );
  }
}
